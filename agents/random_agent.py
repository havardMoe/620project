...
def run_random_agent(env: metasploit_gym.metasploit_env.MetasploitNetworkEnv, step_limit=10, verbose=True):
    if verbose:
        print(LINE_BREAK)
...
if __name__ == "__main__":
    ...
    def environment_reset():
        # TODO
        # Should be able to either reset the state of the target you are attacking
        # Or move over to attacking a new target
    ...
    for i in range(args.runs):
        steps, reward, done = run_random_agent(env, step_limit=10, verbose=True)
